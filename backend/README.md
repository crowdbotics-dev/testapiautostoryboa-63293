...
## Project Structure
    ...
    ├── testapiautostoryboa_63293  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_63293`
...
2. Clone this repo and `cd testapiautostoryboa_63293`
